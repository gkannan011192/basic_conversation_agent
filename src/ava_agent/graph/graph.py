...
from ava_agent.graph.edges import (
    select_workflow,
    should_summarize_conversation
)
from ava_agent.graph.nodes import (
    audio_node,
...
def create_workflow_graph():
    ...
    #Flow of the agent
    # Firstly, extract memories from user message
    graph_builder.add_edge(START,"memory_extraction_node")
    # Next, determine the response type
